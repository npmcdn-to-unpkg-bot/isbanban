...
<!-- Alert Update Data -->
	...
	<div class="row">
		<div class="col-sm-12">
			<a href="<?php echo base_url() ?>admin/blog/add" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
		</div>
	</div>
...
function deleteThis(parameter_code) {
    new PNotify({
        ...
        window.location.href = '<?php echo base_url() ?>' + 'admin/blog/delete/' + parameter_code ;
