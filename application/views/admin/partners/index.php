...
<!-- Alert Update Data -->
	...
	<div class="row">
		<div class="col-sm-12">
			<a href="<?php echo base_url() ?>admin/partners/add" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
		</div>
	</div>
                	...
                	<tr>
                        ...
                        <td>
                            <?php if($item->updated_at) {
                                echo $this->barnlibs->dateForHuman($item->updated_at);
                            } else {
                                echo "Not yet updated";
                            } ?>
                        </td>
                		<td>
                            <a href="<?php echo base_url() ?>admin/partners/edit/<?php echo $item->parameter_code; ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i></a>

                            <a onclick="deleteThis('<?php echo $item->parameter_code; ?>')" href="javascript:void(0);" class="btn btn-xs btn-danger"><i class="fa fa-trash"></i></a>
                        </td>
                	</tr>
                	<?php $nomor++; } ?>
                </tbody>
...
function deleteThis(parameter_code) {
    new PNotify({
        ...
        window.location.href = '<?php echo base_url() ?>' + 'admin/partners/delete/' + parameter_code ;
