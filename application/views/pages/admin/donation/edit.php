            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $row->telefon; ?>" name="donatur_telefon" placeholder="08xxx">
                    </div>
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="<?php echo $row->donasi_banyak; ?>" name="donasi_banyak_buku" placeholder="20">
                    </div>
                    <?php } ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="default" class="form-control moneyFormat" value="<?php echo $row->donasi_banyak; ?>" placeholder="200.000">
